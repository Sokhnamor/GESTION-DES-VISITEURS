...
<a class="text-primary hover:underline dark:text-primary/90" href="{{route('passwordforget')}}">Mot de passe oublié ?</a>
<a class="text-primary hover:underline dark:text-primary/90" href="{{route('inscrir')}}">Créer un compte</a>
</div>
</div>
